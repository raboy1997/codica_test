ActiveAdmin.setup do |config|
  ...
  # https://github.com/svenfuchs/i18n/blob/master/lib%2Fi18n%2Fbackend%2Fbase.
  # rb#L52
  #
  ...
  #
  # Breadcrumbs are enabled by default. You can customize them for
  # individual
